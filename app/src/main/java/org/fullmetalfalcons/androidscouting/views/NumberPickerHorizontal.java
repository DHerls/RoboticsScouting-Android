...
public class NumberPickerHorizontal extends LinearLayout {
    ...
    /**
     * Use a custom NumberPickerHorizontal formatting callback to use two-digit minutes
     * strings like "01". Keeping a static formatter etc. is the most efficient
     * way to do this; it avoids creating temporary objects on every call to
     * format().
     */
    private static class TwoDigitFormatter implements NumberPickerHorizontal.Formatter {
    ...
    /**
     * Lower value of the range of numbers allowed for the NumberPickerHorizontal
     */
    private int mMinValue;

    /**
     * Upper value of the range of numbers allowed for the NumberPickerHorizontal
     */
    private int mMaxValue;

    /**
     * Current value of this NumberPickerHorizontal
     */
    private int mValue;
    ...
    public interface OnValueChangeListener {
         ...
         *
         * @param picker The NumberPickerHorizontal associated with this listener.
         * @param oldVal The previous value.
         * @param newVal The new value.
         */
        void onValueChange(NumberPickerHorizontal picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(NumberPickerHorizontal view, int scrollState);
    }
     ...
     */
    public NumberPickerHorizontal(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        mSolidColor = getResources().getColor(android.R.color.transparent);
        ...
        final int defSelectionDividerDistance = (int) TypedValue.applyDimension(
                ...
                getResources().getDisplayMetrics());
        mSelectionDividersDistance = defSelectionDividerDistance;
        ...
        mMaxWidth = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_PX, 180,
                getResources().getDisplayMetrics());;

        mComputeMaxWidth = (mMaxHeight == SIZE_UNSPECIFIED);
        
        int[] attris = new int[] { android.R.attr.selectableItemBackground};
        TypedArray ta = getContext().obtainStyledAttributes(attris);

        mVirtualButtonPressedDrawable = ta.getDrawable(0);
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mLastDownEventX < mTopSelectionDividerTop) {
                    if (mScrollState == OnScrollListener.SCROLL_STATE_IDLE) {
                        mPressedStateHelper.buttonPressDelayed(
                                PressedStateHelper.BUTTON_DECREMENT);
                    }
                } else if (mLastDownEventX > mBottomSelectionDividerBottom) {
                    if (mScrollState == OnScrollListener.SCROLL_STATE_IDLE) {
                        mPressedStateHelper.buttonPressDelayed(
                ...
                if (!mFlingScroller.isFinished()) {
                    ...
                    mFlingScroller.forceFinished(true);
                    mAdjustScroller.forceFinished(true);
                } else if (mLastDownEventX < mTopSelectionDividerTop) {
                    hideSoftInput();
    ...
    protected boolean dispatchHoverEvent(MotionEvent event) {
        ...
        if (accessibilityManager.isEnabled()) {
            ...
            if (eventX < mTopSelectionDividerTop) {
                hoveredVirtualViewId = AccessibilityNodeProviderImpl.VIRTUAL_VIEW_ID_DECREMENT;
            } else if (eventX > mBottomSelectionDividerBottom) {
    ...
    protected int computeHorizontalScrollRange() {
        return (mMaxValue - mMinValue + 1) * mSelectorElementWidth;
    }
     ...
     * <p>
     * If the argument is less than the {@link NumberPickerHorizontal#getMinValue()} and
     * {@link NumberPickerHorizontal#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link NumberPickerHorizontal#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NumberPickerHorizontal#getMinValue()} and
     * {@link NumberPickerHorizontal#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link NumberPickerHorizontal#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link NumberPickerHorizontal#getMaxValue()} and
     * {@link NumberPickerHorizontal#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link NumberPickerHorizontal#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link NumberPickerHorizontal#getMinValue()} and
     * {@link NumberPickerHorizontal#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mVirtualButtonPressedDrawable != null
            ...
            if (mDecrementVirtualButtonPressed) {
                ...
                mVirtualButtonPressedDrawable.setBounds(0, 0, mTopSelectionDividerTop, getBottom());
                mVirtualButtonPressedDrawable.draw(canvas);
            }
            if (mIncrementVirtualButtonPressed) {
                mVirtualButtonPressedDrawable.setState(PRESSED_STATE_SET);
                mVirtualButtonPressedDrawable.setBounds(mBottomSelectionDividerBottom, 0, getRight(), getBottom());
                mVirtualButtonPressedDrawable.draw(canvas);
            }
        }
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE) {
            	int aux= (int) (y + (float)mTextSize/(float)2);
                canvas.drawText(scrollSelectorValue, x, aux, mSelectorWheelPaint);
            }
        ...
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(topOfTopDivider, 0, bottomOfTopDivider, getBottom());
            mSelectionDivider.draw(canvas);

            // draw the bottom divider
            int bottomOfBottomDivider = mBottomSelectionDividerBottom;
            int topOfBottomDivider = bottomOfBottomDivider - mSelectionDividerHeight;
            mSelectionDivider.setBounds(topOfBottomDivider, 0, bottomOfBottomDivider, getBottom());
            mSelectionDivider.draw(canvas);
        }
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NumberPickerHorizontal.class.getName());
        event.setScrollable(true);
        event.setScrollX((mMinValue + mValue) * mSelectorElementWidth);
        event.setMaxScrollX((mMaxValue - mMinValue) * mSelectorElementWidth);
    }
    ...
    /**
     * Sets the current value of this NumberPickerHorizontal.
     *
     * @param current The new value of the NumberPickerHorizontal.
    ...
    private void initializeSelectorWheel() {
        initializeSelectorWheelIndices();
        int[] selectorIndices = mSelectorIndices;
        int totalTextWidht = selectorIndices.length * mTextSize;
        float totalTextGapWidth = (getRight() - getLeft()) - totalTextWidht;
        ...
        // mInputText
        int editTextTextPosition = (int) (mInputText.getRight() - mSelectorElementWidth*1.5);
    ...
    private void initializeFadingEdges() {
        ...
        setFadingEdgeLength((getRight() - getLeft() - mTextSize) / 2);
    }
    ...
    /**
     * Updates the view of this NumberPickerHorizontal. If displayValues were specified in
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            NumberPickerHorizontal.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
                mIncrementVirtualButtonPressed = false;
                invalidate(mBottomSelectionDividerBottom, 0, getRight(), getBottom());
            }
            mDecrementVirtualButtonPressed = false;
            if (mDecrementVirtualButtonPressed) {
                invalidate(0, 0, mTopSelectionDividerTop, getBottom());
            }
        }
        ...
        public void buttonPressDelayed(int button) {
            ...
            NumberPickerHorizontal.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        public void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            NumberPickerHorizontal.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NumberPickerHorizontal.this.postDelayed(this,
...
//                                clearAccessibilityFocus();
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NumberPickerHorizontal.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (NumberPickerHorizontal.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerHorizontal.this.isEnabled()) {
                                NumberPickerHorizontal.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerHorizontal.this.isEnabled()) {
                                ...
                                NumberPickerHorizontal.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
        	...
        	if (accessibilityManager.isEnabled()) {
                ...
                event.setSource(NumberPickerHorizontal.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(NumberPickerHorizontal.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
                ...
                event.setEnabled(NumberPickerHorizontal.this.isEnabled());
                event.setSource(NumberPickerHorizontal.this, virtualViewId);
                requestSendAccessibilityEvent(NumberPickerHorizontal.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText(
            ...
            info.setSource(NumberPickerHorizontal.this, VIRTUAL_VIEW_ID_INPUT);
...
//            info.setVisibleToUser(isVisibleToUser(boundsInParent));
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(NumberPickerHorizontal.this, virtualViewId);
            info.setParent(NumberPickerHorizontal.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(NumberPickerHorizontal.this.isEnabled());
            Rect boundsInParent = mTempRect;
            boundsInParent.set(left, top, right, bottom);
//            info.setVisibleToUser(isVisibleToUser(boundsInParent));
            info.setBoundsInParent(boundsInParent);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(NumberPickerHorizontal.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(NumberPickerHorizontal.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(NumberPickerHorizontal.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(NumberPickerHorizontal.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(NumberPickerHorizontal.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
